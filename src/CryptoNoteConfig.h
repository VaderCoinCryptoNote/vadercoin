...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x76e8;
...
const char     CRYPTONOTE_NAME[]                             = "VaderCoin";
...
const int      P2P_DEFAULT_PORT                              = 8050;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 8051;
